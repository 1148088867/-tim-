...
- (void)creatVisulBg {
    ...
    effectview.frame = CGRectMake(0, 0 + margin, imageview.frame.size.width, imageview.frame.size.height);
...
- (void)creatSubViews {
    ...
    //猫头
    UIImageView* imgLogin = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width / 2 - 211 / 2, 150-99 + margin, 211, 108)];
    ...
    //展开的左右爪
    imgLeftHandGone = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width / 2 - 100, 150-22+ margin , 40, 40)];
    imgLeftHandGone.image = [UIImage imageNamed:@"icon_hand"];
    [self addSubview:imgLeftHandGone];
    
    
    imgRightHandGone = [[UIImageView alloc] initWithFrame:CGRectMake(self.frame.size.width / 2 + 62,  150-22 + margin, 40, 40)];
    ...
    smallView.frame = CGRectMake(20, 150 + margin, self.frame.size.width-40, self.frame.size.width-40);
    ...
    smallView.frame = CGRectMake(20, 150 + margin, self.frame.size.width-40, CGRectGetMaxY(self.loginBtn.frame)+15);

}

-(void)setIsLogining:(BOOL)isLogining {
