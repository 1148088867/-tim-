...
// 启动图
#define startImageName [[[[NSBundle mainBundle] infoDictionary] objectForKey:@"ConfigureInfo"] objectForKey:@"startImage"]
...
//    imageAdconfiguration.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.width/1242*1786);
    ...
    //广告图片URLString/或本地图片名(.jpg/.gif请带上后缀)
    imageAdconfiguration.imageNameOrURLString = startImageName;
    NSLog(@"%@",startImageName);
    //缓存机制(仅对网络图片有效)
